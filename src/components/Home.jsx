    ...
    <section name={"home"} className={"w-full h-screen bg-[#0a192f]"}>
      ...
      >
        ...
        <p className={"text-[#8892b0] py-4 max-w-[700px]"}>
          ...
          focus on the usability, accessibility, and visual design to create an
          effective and enjoyable interaction between users and the product.
        </p>
        ...
        <div>
          <button
            name={"contact"}
            className={
              "group gap-3 text-white border-2 px-6 py-3 flex items-center hover:bg-blue-600 hover:border-blue-600"
            }
          >
            View Work
