...
const Skills = () => {
  return (
    <div
      name={"skills"}
      className={"w-full h-screen bg-[#0a192f] text-gray-300 py-24"}
    >
      {/* Container */}
      <div
        className={
      ...
      >
        <div>
          <p className={"text-4xl font-bold inline border-b border-blue-500"}>
            Skills
          </p>
        ...
        >
          ...
          >
            <SiTailwindcss
              className={"text-[#6366F1] w-20 mx-auto"}
              size={50}
            />
          ...
          >
            {/* <SiAdobeillustrator className={"text-pink-500 w-20 mx-auto"} size={50} /> */}
            <img
              src="/images/spline.svg"
              className={"text-pink-500 w-20 mx-auto"}
              size={50}
            />
            <p className={"my-4"}>Spline</p>
          </div>
          ...
          >
            <SiFramer className={"text-white w-20 mx-auto"} size={50} />
